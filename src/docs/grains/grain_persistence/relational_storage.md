...
Setting up the connection strings are done as explained in [Orleans Configuration Guide](~/docs/host/configuration_guide/index.md).
...
Read the [ADO.NET Configuration](~/docs/host/configuration_guide/adonet_configuration.md) article for information on configuring your database, including the corresponding ADO.NET Invariant and setup scripts.
